...
def parse_args():
    ...
    #W&B
    parser.add_argument('--wandb_project', type=str, default='talkshow-default', help='Nombre del proyecto en WandB')
    parser.add_argument('--wandb_run_name', type=str, default=None, help='Nombre del experimento en WandB (opcional)')
